...
class LottoResultTest {
    ...
    void 등수별_집계_테스트() {
        ...
        LottoStatisticsResult result = lottoService.calculateResult(purchased, winningLotto, 5000);
    ...
    void 수익률_계산() {
        ...
        LottoStatisticsResult result = lottoService.calculateResult(purchased, winningLotto, 1000);
