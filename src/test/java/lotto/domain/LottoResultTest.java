...
class LottoResultTest {
    ...
    void 등수별_집계_테스트() {
        ...
        LottoResult result = new LottoResult(purchased, winningLotto, 5000);
    ...
    void 총상금_계산() {
        WinningLotto winningLotto = new WinningLotto(List.of(1, 2, 3, 4, 5, 6), 7);
        List<Lotto> purchased = List.of(
                new Lotto(List.of(1, 2, 3, 4, 5, 6)), // 1등 2,000,000,000
                new Lotto(List.of(1, 2, 3, 4, 5, 7))  // 2등 30,000,000
        );

        LottoResult result = new LottoResult(purchased, winningLotto, 2000);
        assertThat(result.getTotalPrize()).isEqualTo(2_030_000_000);
    }
    ...
    void 수익률_계산() {
        ...
        LottoResult result = new LottoResult(purchased, winningLotto, 1000);
